...
\newcommand{\thesisTitle}{RAPID:Application Quality and Resource Usage Trade-offs with Approximation} % your thesis/dissertation title, e.g., How to Write A Thesis
\newcommand{\yourName}{Liu Liu} % your name, e.g., Tim Cook
\newcommand{\yourDegree}{Doctor of Philosopy} % your degree to be obtained, e.g., Master of Science, Doctor of Philosophy
...
\newcommand{\yourDirector}{Ulrich Kremer} % your thesis director name here, his/her title not included
\newcommand{\yourCommitteeNumber}{4} % IMPORTANT! the number of the committee members for your defense
\newcommand{\yourMonth}{Oct} % your graduation month, not your defense month
